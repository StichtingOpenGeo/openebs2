...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Kv15Log.messagecodenumber'
        db.alter_column(u'openebs_kv15log', 'messagecodenumber', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Kv17Change.operatingday'
        db.alter_column(u'openebs_kv17change', 'operatingday', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Kv15Stopmessage.messagecodenumber'
        db.alter_column(u'openebs_kv15stopmessage', 'messagecodenumber', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Kv15Log.messagecodenumber'
        db.alter_column(u'openebs_kv15log', 'messagecodenumber', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=0))

        # Changing field 'Kv17Change.operatingday'
        db.alter_column(u'openebs_kv17change', 'operatingday', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'Kv15Stopmessage.messagecodenumber'
        db.alter_column(u'openebs_kv15stopmessage', 'messagecodenumber', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=0))
    ...
    models = {
        ...
        u'openebs.kv15stopmessage': {
            ...
            'messagedurationtype': ('django.db.models.fields.CharField', [], {'default': "u'ENDTIME'", 'max_length': '10'}),
            'messageendtime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 22, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'messagepriority': ('django.db.models.fields.CharField', [], {'default': "u'PTPROCESS'", 'max_length': '10'}),
