...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'openebs_kv1line', (
        ...
        db.send_create_signal(u'openebs', ['Kv1Line'])

        # Adding unique constraint on 'Kv1Line', fields ['dataownercode', 'lineplanningnumber']
        db.create_unique(u'openebs_kv1line', ['dataownercode', 'lineplanningnumber'])
    ...
    def backwards(self, orm):
        ...
        db.delete_unique(u'openebs_kv1line', ['dataownercode', 'lineplanningnumber'])

        # Deleting model 'Kv1Line'
        db.delete_table(u'openebs_kv1line')
    ...
    models = {
        ...
        u'openebs.kv1line': {
            'Meta': {'unique_together': "((u'dataownercode', u'lineplanningnumber'),)", 'object_name': 'Kv1Line'},
            'dataownercode': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
