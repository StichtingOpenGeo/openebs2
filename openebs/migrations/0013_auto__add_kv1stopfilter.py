...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Kv1StopFilter'
        db.create_table(u'openebs_kv1stopfilter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')(max_length=25)),
        ))
        db.send_create_signal(u'openebs', ['Kv1StopFilter'])
    ...
    def backwards(self, orm):
        # Deleting model 'Kv1StopFilter'
        db.delete_table(u'openebs_kv1stopfilter')
    ...
    models = {
        ...
        u'openebs.kv15stopmessage': {
            ...
            'messagedurationtype': ('django.db.models.fields.CharField', [], {'default': "u'ENDTIME'", 'max_length': '10'}),
            'messageendtime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 7, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'messagepriority': ('django.db.models.fields.CharField', [], {'default': "u'PTPROCESS'", 'max_length': '10'}),
        ...
        u'openebs.kv1stopfilter': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {'max_length': '25'}),
            'stops': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['kv1.Kv1Stop']", 'symmetrical': 'False'})
        },
