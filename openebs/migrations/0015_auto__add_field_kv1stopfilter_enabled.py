...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Kv1StopFilter.enabled'
        db.add_column(u'openebs_kv1stopfilter', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Kv1StopFilter.enabled'
        db.delete_column(u'openebs_kv1stopfilter', 'enabled')
