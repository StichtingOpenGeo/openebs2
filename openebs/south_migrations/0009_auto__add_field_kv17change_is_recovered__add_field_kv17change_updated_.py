...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Kv17Change.is_recovered'
        db.add_column(u'openebs_kv17change', 'is_recovered',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Kv17Change.updated'
        db.add_column(u'openebs_kv17change', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 11, 25, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Kv17StopChange.updated'
        db.delete_column(u'openebs_kv17stopchange', 'updated')

        # Deleting field 'Kv17JourneyChange.updated'
        db.delete_column(u'openebs_kv17journeychange', 'updated')

        # Deleting field 'Kv17JourneyChange.is_recovered'
        db.delete_column(u'openebs_kv17journeychange', 'is_recovered')


    def backwards(self, orm):
        # Deleting field 'Kv17Change.is_recovered'
        db.delete_column(u'openebs_kv17change', 'is_recovered')

        # Deleting field 'Kv17Change.updated'
        db.delete_column(u'openebs_kv17change', 'updated')


        # User chose to not deal with backwards NULL issues for 'Kv17StopChange.updated'
        raise RuntimeError("Cannot reverse this migration. 'Kv17StopChange.updated' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Kv17StopChange.updated'
        db.add_column(u'openebs_kv17stopchange', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Kv17JourneyChange.updated'
        raise RuntimeError("Cannot reverse this migration. 'Kv17JourneyChange.updated' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Kv17JourneyChange.updated'
        db.add_column(u'openebs_kv17journeychange', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Kv17JourneyChange.is_recovered'
        db.add_column(u'openebs_kv17journeychange', 'is_recovered',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        u'openebs.kv15stopmessage': {
            ...
            'messagecontent': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'messagedurationtype': ('django.db.models.fields.CharField', [], {'default': "u'ENDTIME'", 'max_length': '10'}),
            'messageendtime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 26, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'messagepriority': ('django.db.models.fields.CharField', [], {'default': "u'PTPROCESS'", 'max_length': '10'}),
