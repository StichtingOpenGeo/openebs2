...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Kv15MessageLine', fields ['stopmessage', 'line']
        db.create_unique(u'openebs_kv15messageline', ['stopmessage_id', 'line_id'])

        # Adding unique constraint on 'Kv15MessageStop', fields ['stopmessage', 'stop']
        db.create_unique(u'openebs_kv15messagestop', ['stopmessage_id', 'stop_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Kv15MessageStop', fields ['stopmessage', 'stop']
        db.delete_unique(u'openebs_kv15messagestop', ['stopmessage_id', 'stop_id'])

        # Removing unique constraint on 'Kv15MessageLine', fields ['stopmessage', 'line']
        db.delete_unique(u'openebs_kv15messageline', ['stopmessage_id', 'line_id'])
