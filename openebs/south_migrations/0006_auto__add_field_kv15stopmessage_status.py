...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Kv15Stopmessage.status'
        db.add_column(u'openebs_kv15stopmessage', 'status',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Kv15Stopmessage.status'
        db.delete_column(u'openebs_kv15stopmessage', 'status')
    ...
    models = {
        ...
        u'openebs.kv15stopmessage': {
            ...
            'messagecontent': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'messagedurationtype': ('django.db.models.fields.CharField', [], {'default': "u'ENDTIME'", 'max_length': '10'}),
            'messageendtime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 17, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'messagepriority': ('django.db.models.fields.CharField', [], {'default': "u'PTPROCESS'", 'max_length': '10'}),
