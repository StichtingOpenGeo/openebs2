...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Kv17Change.created'
        db.add_column(u'openebs_kv17change', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 12, 8, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Kv17Change.recovered'
        db.add_column(u'openebs_kv17change', 'recovered',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding unique constraint on 'Kv17Change', fields ['operatingday', 'line', 'journey', 'reinforcement']
        db.create_unique(u'openebs_kv17change', ['operatingday', 'line_id', 'journey_id', 'reinforcement'])


    def backwards(self, orm):
        # Removing unique constraint on 'Kv17Change', fields ['operatingday', 'line', 'journey', 'reinforcement']
        db.delete_unique(u'openebs_kv17change', ['operatingday', 'line_id', 'journey_id', 'reinforcement'])


        # User chose to not deal with backwards NULL issues for 'Kv17Change.updated'
        raise RuntimeError("Cannot reverse this migration. 'Kv17Change.updated' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Kv17Change.updated'
        db.add_column(u'openebs_kv17change', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True),
                      keep_default=False)

        # Deleting field 'Kv17Change.created'
        db.delete_column(u'openebs_kv17change', 'created')

        # Deleting field 'Kv17Change.recovered'
        db.delete_column(u'openebs_kv17change', 'recovered')
    ...
    models = {
        ...
        u'kv1.kv1journey': {
            ...
            'departuretime': ('django.db.models.fields.TimeField', [], {}),
        ...
        u'openebs.kv15stopmessage': {
            ...
            'messagecontent': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'messagedurationtype': ('django.db.models.fields.CharField', [], {'default': "u'ENDTIME'", 'max_length': '10'}),
            'messageendtime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 9, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'messagepriority': ('django.db.models.fields.CharField', [], {'default': "u'PTPROCESS'", 'max_length': '10'}),
        ...
        u'openebs.kv17change': {
            ...
            'recovered': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
