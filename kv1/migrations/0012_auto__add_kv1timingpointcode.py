...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'kv1_kv1timingpointcode', (
            ...
            ('timingpointcode', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10)),
        ))
    ...
    models = {
        ...
        u'kv1.kv1timingpointcode': {
            'Meta': {'object_name': 'Kv1TimingPointCode'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'stop': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['kv1.Kv1Stop']"}),
            'timingpointcode': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '10'})
        }
    }
