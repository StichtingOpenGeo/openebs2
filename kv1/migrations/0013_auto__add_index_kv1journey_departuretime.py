...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Kv1Journey', fields ['departuretime']
        db.create_index(u'kv1_kv1journey', ['departuretime'])


    def backwards(self, orm):
        # Removing index on 'Kv1Journey', fields ['departuretime']
        db.delete_index(u'kv1_kv1journey', ['departuretime'])
