...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Kv1Journey.departuretime'
        db.add_column(u'kv1_kv1journey', 'departuretime',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.time(11, 59, 16, 726705)),
                      keep_default=False)

        # Adding field 'Kv1Journey.direction'
        db.add_column(u'kv1_kv1journey', 'direction',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Kv1Journey.direction'
        db.delete_column(u'kv1_kv1journey', 'direction')
