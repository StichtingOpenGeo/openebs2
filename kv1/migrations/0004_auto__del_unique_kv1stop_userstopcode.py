...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Kv1Stop', fields ['userstopcode']
        db.delete_unique(u'kv1_kv1stop', ['userstopcode'])


    def backwards(self, orm):
        # Adding unique constraint on 'Kv1Stop', fields ['userstopcode']
        db.create_unique(u'kv1_kv1stop', ['userstopcode'])
