...
from kv1.views import LineSearchView, LineStopView, ActiveStopListView, LineTripView, DataImportView, \
    ActiveMessagesForStopView, StopAutocompleteView, StopLineFilterView, StopLineSearchView, StopSearchView
...
urlpatterns = [
    ...
    url(r'^stop/lines$', StopLineFilterView.as_view(), name="stopline_filter"),
