...
class TestFerryKv6Messages(TestCase):
    ...
    def setUpClass(cls):
        ...
        j2.save()
        j3 = Kv1Journey(dataownercode="WSF", line=cls.line, journeynumber=3, direction=1, scheduleref=1, departuretime=cls.calc(datetime.now()-timedelta(minutes=6)))
        j3.save()
    ...
    def test_send_initial(self):
        ...
        self.assertEqual(FerryKv6Messages.Status.INITIALIZED, msgs[2].status)
